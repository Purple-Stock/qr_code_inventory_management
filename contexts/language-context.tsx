...
const translations = {
  en: {
    ...
    current_location_value: "Current Location & Value",
    no_location_history: "No location history available",
  ...
  pt: {
    ...
    no_transactions: "Nenhuma transação para mostrar",
    total_in_stock: "Total em estoque",
    location_history: "Histórico de Localização",
    location_distribution: "Distribuição por Localização",
    current_location_value: "Localização e Valor Atual",
    no_location_history: "Nenhum histórico de localização disponível",
    no_location_data: "Nenhum dado de localização disponível",
    last_updated: "Última atualização",
    added_to: "Adicionado a",
    removed_from: "Removido de",
